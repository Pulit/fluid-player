...
var fluidPlayerCreator = function () {
    return {
        ...
        notCloned: ['notCloned', 'vttParserScript', 'instances', 'getInstanceById',
            ...
            'toggleElementText', 'openWindow', 'getMobileOs', 'findClosestParent', 'activeVideoPlayerId',
            'getInstanceIdByWrapperId', 'timer', 'timerPool', 'adList', 'adPool',
            'isUserActive', 'isCurrentlyPlayingAd', 'initialAnimationSet', 'firstPlayLaunched', 'destroyed'],
        version: '2.4.4',
        homepage: 'https://www.fluidplayer.com/',
        activeVideoPlayerId: null,
        onOpenWindowFunction: null,
        destroyed: false,
        ...
        openWindow: function (player, url, target) {
            if (fluidPlayerClass.getMobileOs().userOs) {
                if (player.onOpenWindowFunction !== null) {
                    player.onOpenWindowFunction(url, target);
                    return;
                }
            }
        ...
        playRoll: function (adListId) {
            ...
            var playVideoPlayer = function (adListId) {
                ...
                player.trackSingleEvent('creativeView');
        ...
        createBoard: function (adListId) {
            ...
            board.onclick = function () {
                if (typeof vastSettings.clickthroughUrl !== 'undefined') {
                    fluidPlayerClass.openWindow(player, vastSettings.clickthroughUrl);
                }
        ...
        addAdCountdown: function () {
            ...
            divAdCountdown.innerHTML = adCountdown;
        ...
        decreaseAdCountdown: function decreaseAdCountdown() {
            ...
            if (btn) {
                btn.innerHTML = player.pad(parseInt(sec / 60)) + ':' + player.pad(parseInt(sec % 60));
            } else {
        ...
        addCTAButton: function (landingPage) {
            ...
            ctaButton.addEventListener('click', function () {
                ...
                fluidPlayerClass.openWindow(player, player.vastOptions.clickthroughUrl, '_blank');
                return true;
            }, false);
        ...
        addClickthroughLayer: function () {
            ...
            var openClickthrough = function () {
                fluidPlayerClass.openWindow(player, player.vastOptions.clickthroughUrl);
        ...
        onFluidPlayerPause: function () {
            ...
            setTimeout(function () {
                ...
                if (player !== null && !player.recentWaiting) {
        ...
        setCustomContextMenu: function () {
            ...
            menuOptionHomepage.addEventListener('click', function () {
                fluidPlayerClass.openWindow(player, player.homepage, '_blank');
            }, false);
        },
        ...
        checkIfVolumebarIsRendered: function () {
            ...
            if (!volumeposTag || volumeposTag === null) {
                return false;
            }
        ...
        on: function (eventCall, functionCall) {
            ...
            switch (eventCall) {
                ...
                case 'theatreModeOff':
                    ...
                    break;
                case 'openUrl':
                    this.onOpenWindowFunction = functionCall;
                    break;
                default:
...
var fluidPlayerClass = fluidPlayerCreator();
